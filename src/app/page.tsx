...
import Template5Carousel from "../components/Template5Carousel";
import Template6Carousel from "../components/Template6Carousel";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10">
      ...
      <div className="flex gap-2 mb-8">
        ...
        <button
          className={`px-6 py-2 rounded-t-lg font-semibold border-b-2 transition-all duration-150 ${activeTab === 4 ? 'bg-white border-blue-600 text-blue-700 shadow' : 'bg-gray-100 border-transparent text-gray-500'}`}
          onClick={() => setActiveTab(4)}
        >
          Шаблон 4
        </button>
        <button
          className={`px-6 py-2 rounded-t-lg font-semibold border-b-2 transition-all duration-150 ${activeTab === 5 ? 'bg-white border-blue-600 text-blue-700 shadow' : 'bg-gray-100 border-transparent text-gray-500'}`}
          onClick={() => setActiveTab(5)}
        >
          Шаблон 5
        </button>
        <button
          className={`px-6 py-2 rounded-t-lg font-semibold border-b-2 transition-all duration-150 ${activeTab === 6 ? 'bg-white border-blue-600 text-blue-700 shadow' : 'bg-gray-100 border-transparent text-gray-500'}`}
      ...
      {activeTab === 4 && <Template4Carousel />}
      {activeTab === 5 && <Template5Carousel />}
      {activeTab === 6 && <Template6Carousel />}
    </div>
  );
}
